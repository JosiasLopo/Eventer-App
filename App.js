                          ...
                          <View>
                              <View style={{flex: 1,paddingLeft: responsiveWidth(2), paddingRight: responsiveWidth(2)}}>
                                  ...
                                  <View style={{gap: responsiveWidth(4), height: responsiveHeight(50), justifyContent: "center", marginLeft: responsiveWidth(7)}}>
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('MediaWidget')} style={{flexDirection:"row", alignItems: "center"}}><Ionicons name="locate" size={responsiveWidth(7)} style={{marginRight: responsiveWidth(4)}}  color="white"  /><Text style={{color: "white", fontFamily: "MPLUS1p", fontSize: responsiveFontSize(2)}}>Localizations</Text></TouchableOpacity>
                                  </View>
                                  <View style={{
                                    borderBottomColor: '#525468',
                                    borderBottomWidth: 1,
